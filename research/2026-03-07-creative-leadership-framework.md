...
date: 2026-03-07
topic: Creative Leadership Framework — Hybrid Studio + Product Operating Model
tags:
  - governance
  - lifecycle
  - raci
  ...
  - hybrid-model
  - north-star
content_hash: 25241fcfececbd36c58183922fc691729a3f69ecc26e3c8d2b462fce5310bc7a
ingested_via: claude-code-manual
original_file: organ-logic-Creative-Leadership-Framework.md
status: reference
cross_references:
...
# Creative Leadership Framework — Hybrid Studio + Product Operating Model

> Ingested from ChatGPT Q/A transcript. Covers 9-phase lifecycle, RACI matrix, artifact checklist, team topology, governance gates, and project shell template for a hybrid creative+product operating model.

## Relationship to ORGANVM North Star

This framework is the **operational doctrine** for the vision declared in [`meta-organvm/VISION.md`](../VISION.md). The three North Star pillars map directly:

| North Star Pillar | Framework Mechanism |
|---|---|
| Anti-Stagnation Governance | 9-phase lifecycle with gate enforcement; phases 0-3 prevent waste, 7-8 retain value |
| Ethical Human-in-Loop | "Director lane" pattern — decide intent, taste, ship authority; agents/team handle production |
| Individual→Enterprise Amplification | Core Pod + Bench + Vendor topology, where agent archetypes replace headcount |

The $-prefixed artifact IDs (`$VISION_BRIEF`, `$SYSTEM_SPEC`, `$TEST_REPORTS`) are candidate naming conventions for Conductor workflow steps and handoff envelopes.

See also: [`2026-03-07-era-of-the-orchestrator.md`](./2026-03-07-era-of-the-orchestrator.md) — the companion argument for why specification scarcity (not implementation scarcity) is the bottleneck this framework addresses.
