...
**Actions taken:**
- ToolSearch
- Read `~/Workspace/meta-organvm/organvm-engine/src/organvm_engine/session/__init__.py`
...
- Read `~/Workspace/meta-organvm/organvm-engine/src/organvm_engine/session/agents.py`
...
- Read `~/Workspace/meta-organvm/organvm-engine/src/organvm_engine/session/parser.py`
- Write `~/Workspace/meta-organvm/organvm-engine/src/organvm_engine/session/plans.py`
- Write `~/Workspace/meta-organvm/organvm-engine/src/organvm_engine/session/analysis.py`
