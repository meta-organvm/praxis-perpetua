...
- Read `~/Workspace/organvm-iii-ergon/peer-audited--behavioral-blockchain/src/api/src/modules/fury/fury.worker.demotion.spec.ts`
- Grep `LedgerService`
- *...and 45 more*
...
- Glob `docs/legal/*`
- Read `~/Workspace/organvm-iii-ergon/peer-audited--behavioral-blockchain/docs/legal/compliance.md`
