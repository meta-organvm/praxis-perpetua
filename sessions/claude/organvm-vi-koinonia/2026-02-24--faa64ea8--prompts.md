...
**Session ID:** `faa64ea8-05a7-4511-b149-41624a840d52`
...
### P1 — 2026-02-24 10:30:16

Implement the following plan:

# ORGAN-VI (Koinonia) — Full Sweep Forward Propulsion

## Context

ORGAN-VI has **substantial implementation depth** across 5 repos — 4 PostgreSQL schemas, full async/sync ORM models, repository patterns, a feature-rich FastAPI flagship (WebSocket live rooms, Atom feeds, full-text search, CSRF, rate limiting, adaptive syllabus generation), and cross-organ event workflows already wired (V→VI essay-to-community, VI→VII community-to-kerygma). But everything sits at `L
