...
- Grep `\[x\]`
- Grep `\[ \]`
- Bash: `grep -c '\[ \]' ~/Workspace/meta-organvm/organvm-corpvs-testamentvm/doc`
- Read `~/Workspace/meta-organvm/organvm-corpvs-testamentvm/docs/operations/rolling-todo.md`
- Bash: `grep -n '\[ \]' ~/Workspace/meta-organvm/organvm-corpvs-testamentvm/doc`
- Edit `~/Workspace/meta-organvm/organvm-corpvs-testamentvm/docs/operations/rolling-todo.md`
- Bash: `echo "=== Verification ===" && echo "Open items: $(grep -c '\[ \]' ~/Wo`
